...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen text-gray-900 scroll-smooth">
      {/* HEADER */}
      ...
      <section
        id="inicio"
        className="pt-28 pb-16 md:pt-32 bg-gradient-to-br from-green-500 via-green-400 to-green-300 text-white"
      >
