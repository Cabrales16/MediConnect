    ...
    <>
      <div className="bg-white rounded-2xl border border-gray-400 shadow-sm p-6">
        ...
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold">Detalles del {user.rol}</h3>
          <button
            onClick={onClose}
        ...
        <div className="space-y-2 text-sm text-gray-700">
          ...
          <p>
            <strong>Documento:</strong> {user.tipo_documento}{' '}
            {user.num_documento}
          </p>
          <p>
          ...
          {user.id_rol === 2 && (
            <>
              ...
              <p>
                <strong>Calificación:</strong> {user.calificacion}
              </p>
            </>
          )}
          <p>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          {user.rol === 'Paciente' && (
            ...
            >
              <img
                src={verTratamientosIcon}
                alt="Ver tratamientos"
                className="w-6"
              />
            </button>
          )}
          ...
          >
            <img
              src={deshabilitarIcon}
              alt="Deshabilitar cuenta"
              className="w-6"
            />
          </button>
        </div>
