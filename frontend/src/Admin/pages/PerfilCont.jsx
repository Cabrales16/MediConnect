      ...
      <div className="overflow-y-auto h-[calc(100vh-6rem)]">
        <div className="p-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-300 p-6 max-w-2xl">
            {/* 🔹 Encabezado con avatar e icono de editar */}
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                {/* Avatar circular con iniciales */}
                <div className="flex items-center justify-center w-16 h-16 rounded-full bg-green-500 text-white font-bold text-xl shadow-md">
                  {user
