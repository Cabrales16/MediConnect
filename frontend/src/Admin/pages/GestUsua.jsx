  ...
  useEffect(() => {
    const pacientesMock = [
      ...
      // 🔹 Pacientes adicionales
      {
        ...
        nombre: "Valentina",
        apellido: "Rodríguez",
        correo: "valentina.rod@example.com",
        telefono: "3201112233",
        direccion: "Calle 21 #34-11",
        genero: "Femenino",
      ...
      },
      {
        ...
        telefono: "3019988776",
        direccion: "Av. 68 #72-30",
        genero: "Femenino",
        fecha_registro: "2025-07-02",
        id_rol: 3,
      },
      {
        id_usuario: 8,
        ...
        telefono: "3004445566",
        direccion: "Calle 40 #15-80",
        genero: "Masculino",
        fecha_registro: "2025-03-28",
        id_rol: 3,
      },
      {
        id_usuario: 9,
      ...
      },
      {
        ...
        nombre: "Felipe",
        apellido: "González",
        correo: "felipe.gonzalez@example.com",
        telefono: "3007788990",
        direccion: "Carrera 13 #45-25",
        genero: "Masculino",
      ...
      },
      {
        ...
        nombre: "Camila",
        apellido: "López",
        correo: "camila.lopez@example.com",
        telefono: "3224455667",
        direccion: "Calle 33 #40-09",
        genero: "Femenino",
      ...
      },
      {
        ...
        telefono: "3115566778",
        direccion: "Carrera 12 #18-44",
        genero: "Femenino",
        fecha_registro: "2025-08-03",
        id_rol: 3,
      },
    ];
    ...
    const medicosMock = [
      ...
      },
      {
        ...
        nombre: "Mariana",
        apellido: "Rojas",
        correo: "mariana.rojas@example.com",
        telefono: "3205566778",
        direccion: "Calle 99 #20-45",
        genero: "Femenino",
      ...
      },
      {
        ...
        nombre: "Jorge",
        apellido: "Patiño",
        correo: "jorge.patino@example.com",
        telefono: "3117788990",
        direccion: "Av. Suba #102-11",
        genero: "Masculino",
      ...
      },
      {
        ...
        nombre: "Catalina",
        apellido: "Gómez",
        correo: "catalina.gomez@example.com",
        telefono: "3128899001",
        direccion: "Calle 120 #45-08",
        genero: "Femenino",
      ...
      },
      {
        ...
        nombre: "Fernando",
        apellido: "Serrano",
        correo: "fernando.serrano@example.com",
        telefono: "3012233445",
        direccion: "Av. 26 #10-50",
        genero: "Masculino",
        especialidad: "Medicina General",
        calificacion: 4.4,
        fecha_registro: "2025-06-04",
        id_rol: 2,
      },
      {
        id_usuario: 21,
        nombre: "Isabela",
        apellido: "Martínez",
        correo: "isabela.martinez@example.com",
        telefono: "3205566779",
        direccion: "Carrera 11 #89-30",
        genero: "Femenino",
      ...
      },
      {
        ...
        nombre: "Camilo",
        apellido: "Fernández",
        correo: "camilo.fernandez@example.com",
        telefono: "3129988771",
        direccion: "Calle 100 #25-40",
        genero: "Masculino",
